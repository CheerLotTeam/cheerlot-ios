...
extension Color {
  ...
  static let systemChange: Color = .change
  static let systemBG: Color = .grayWhite
  ...
  static func teamPrimaryPalette(for assetPrefix: String) -> TeamPrimaryPalette {
    ...
    case "hh":
      return TeamPrimaryPalette(
        color100: .hhOrange100,
        color200: .hhOrange200,
        color300: .hhOrange300,
        color500: .hhOrange500,
        color600: .hhOrange600
      )
    case "lg":
      return TeamPrimaryPalette(
        color100: .lgRed100,
    ...
    case "nc":
      return TeamPrimaryPalette(
        color100: .ncDeepblue100,
        color200: .ncDeepblue200,
        color300: .ncDeepblue300,
        color500: .ncDeepblue500,
        color600: .ncDeepblue600
      )
    case "kt":
      return TeamPrimaryPalette(
        color100: .ktJetblack100,
        color200: .ktJetblack200,
        color300: .ktJetblack300,
        color500: .ktJetblack500,
        color600: .ktJetblack600,
      )
    case "ssg":
      return TeamPrimaryPalette(
        color100: .ssgDeepred100,
        color200: .ssgDeepred200,
        color300: .ssgDeepred300,
        color500: .ssgDeepred500,
        color600: .ssgDeepred600
      )
    case "ds":
      return TeamPrimaryPalette(
        color100: .dsMidnight100,
        color200: .dsMidnight200,
        color300: .dsMidnight300,
        color500: .dsMidnight500,
        color600: .dsMidnight600
      )
    case "kw":
      return TeamPrimaryPalette(
        color100: .kwBurgundy100,
        color200: .kwBurgundy200,
        color300: .kwBurgundy300,
        color500: .kwBurgundy500,
        color600: .kwBurgundy600
      )
    case "kia":
      return TeamPrimaryPalette(
        color100: .kiaScarlet100,
        color200: .kiaScarlet200,
        color300: .kiaScarlet300,
        color500: .kiaScarlet500,
        color600: .kiaScarlet600
      )
    default:
      return TeamPrimaryPalette(
        color100: .clear,
