...
struct PlayerInfo: Identifiable, Hashable, Equatable {
    ...
    init(id: PlayerID, teamId: TeamID, name: String, backNumber: Int, position: String? = nil, batThrow: String? = nil, battingOrder: Int? = nil, isStarter: Bool, cheerSongs: [CheerSongInfo] = []) {
        self.id = id
        self.teamId = teamId
        self.name = name
