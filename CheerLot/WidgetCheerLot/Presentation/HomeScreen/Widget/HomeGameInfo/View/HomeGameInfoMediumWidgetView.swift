...
struct HomeGameInfoMediumWidgetView: View {
    ...
    var body: some View {
        ...
        case .seasonEnded:
            GameInfoView(isSmallSize: false, title: "시즌 종료", dateString: entry.date.koreanDateFormatted, capsuleTitle: "최근 라인업", asset: teamAsset)
        case .offDay:
            GameInfoView(isSmallSize: false, title: "경기 없음", dateString: entry.date.koreanDateFormatted, capsuleTitle: "이전 라인업", asset: teamAsset)
        case .playingToday:
            playingTodayView
        }
    }
