...
extension Color {
  ...
  static func teamColors(for assetPrefix: String) -> TeamColorSet {
    switch assetPrefix {
    case "hh":
        return TeamColorSet(primary: .hanwhaPrimary, secondary: .hanwhaSecondary, bgGradient: .hanwhaPrimary)
    case "lg":
      return TeamColorSet(primary: .lgPrimary, secondary: .lgSecondary, bgGradient: .lgPrimary)
    case "lt":
      return TeamColorSet(primary: .lottePrimary, secondary: .lotteSecondary, bgGradient: .lottePlayDisable)
    case "ss":
      return TeamColorSet(primary: .samsungPrimary, secondary: .samsungSecondary, bgGradient: .samsungPrimary)
    case "nc":
    ...
    case "ds":
      return TeamColorSet(primary: .doosanPrimary, secondary: .doosanSecondary, bgGradient: .doosanPlayDisable)
    case "kw":
      return TeamColorSet(primary: .kiwoomPrimary, secondary: .kiwoomSecondary, bgGradient: .kiwoomPrimary)
    case "kia":
